...
var agenda = require('agenda')({ db: { address: 'mongodb://talkie:trackr@ds143774.mlab.com:43774/talkie-trackr'  } });
...
mongoose.connect('mongodb://talkie:trackr@ds143774.mlab.com:43774/talkie-trackr' );
